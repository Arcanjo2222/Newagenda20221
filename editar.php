              ...
              <?php 
                  ...
                  if(isset($_POST['btnCContato'])){
                    ...
                    if(in_array($extensao,$formatP)){
                      ...
                      $temporario=$_FILES['foto']['tmp_name'];//Caminho temporário da imagem
                      $novoNome=uniqid().".$extensao";//uniqid(criptografa o nome da imagem),depois concatena com a extensão
